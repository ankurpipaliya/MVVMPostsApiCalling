...
//    }
    ...
    //MARK: - THIS IS FOR Separated MacAddress :
    func getMacAddressSeparated()-> String{
        return self.split(":").joined(separator: "").uppercased()
    }
...
//    }
    ...
    func getDeviceSerialID() -> String {
        let arrTopicstrName = self.components(separatedBy: "/")
        if arrTopicstrName.count > 2{
            return arrTopicstrName[2]
        }
        return ""
    }
